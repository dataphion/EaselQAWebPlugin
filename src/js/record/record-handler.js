...
var typeTarget;
var typeLock = 0;
EventRecorder.inputTypes = ["text", "password", "file", "datetime", "datetime-local", "date", "month", "time", "week", "number", "range", "email", "url", "search", "tel", "color"];
...
EventRecorder.addEventHandler('clickAt', 'click', function(event) {
...
// © Chen-Chieh Ping, SideeX Team
EventRecorder.addEventHandler('doubleClickAt', 'dblclick', function(event) {
    var top = event.pageY,
        left = event.pageX;
    var element = event.target;
    do {
...
var enterValue = null;
var tabCheck = null;
EventRecorder.addEventHandler('sendKeys', 'keydown', function(event) {
...
EventRecorder.addEventHandler('dragAndDrop', 'mousedown', function(event) {
    var self = this;
...
// © Shuo-Heng Shih, SideeX Team
EventRecorder.addEventHandler('dragAndDrop', 'mouseup', function(event) {
...
// © Shuo-Heng Shih, SideeX Team
EventRecorder.addEventHandler('dragAndDropToObject', 'dragstart', function(event) {
    var self = this;
...
// © Shuo-Heng Shih, SideeX Team
EventRecorder.addEventHandler('dragAndDropToObject', 'drop', function(event) {
...
EventRecorder.addEventHandler('runScript', 'scroll', function(event) {
    if (pageLoaded === true) {
        var self = this;
...
// © Shuo-Heng Shih, SideeX Team
var nowNode = 0;
EventRecorder.addEventHandler('mouseOver', 'mouseover', function(event) {
...
// © Shuo-Heng Shih, SideeX Team
EventRecorder.addEventHandler('mouseOut', 'mouseout', function(event) {
...
// © Shuo-Heng Shih, SideeX Team
EventRecorder.addEventHandler('mouseOver', 'DOMNodeInserted', function(event) {
...
var pageLoaded = true;
EventRecorder.addEventHandler('checkPageLoaded', 'readystatechange', function(event) {
    var self = this;
...
EventRecorder.addEventHandler('contextMenu', 'contextmenu', function(event) {
...
var getEle;
var checkFocus = 0;
EventRecorder.addEventHandler('editContent', 'focus', function(event) {
...
// © Yun-Wen Lin, SideeX Team
EventRecorder.addEventHandler('editContent', 'blur', function(event) {
    if (checkFocus == 1) {
...
EventRecorder.addEventHandler('select', 'focus', function(event) {
    if (event.target.nodeName) {
        var tagName = event.target.nodeName.toLowerCase();
