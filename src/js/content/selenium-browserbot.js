...
import {objectExtend,URLConfiguration} from "./utils"
import {bot,core} from "./atoms"
import {browserVersion,parse_locator,SeleniumError,addLoadListener} from "./utils"
import {goog} from "./atoms"
import { _error } from "../background/helperFunctions";

export var BrowserBot = function(topLevelApplicationWindow) {
    ...
    this.xpathEvaluator = new XPathEvaluator(); // change to "javascript-xpath" for the newer, faster engine
...
BrowserBot.prototype.locateElementsByXPath = function(xpath, inDocument, inWindow) {
    return this.xpathEvaluator.evaluate( xpath,inDocument,
        inDocument.createNSResolver ? inDocument.createNSResolver(inDocument.documentElement) : this._namespaceResolver);
};
...
export function MozillaBrowserBot(frame) {
    BrowserBot.call(this, frame);
}
objectExtend(MozillaBrowserBot.prototype, BrowserBot.prototype);

export function KonquerorBrowserBot(frame) {
    BrowserBot.call(this, frame);
}
