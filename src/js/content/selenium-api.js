...
import {browserVersion,getAncestorOrSelfWithJavascriptHref,SeleniumError} from "./utils"
...
export function Selenium(browserbot) {
    /**
...
Selenium.prototype.doStore = function(value, varName) {
    chrome.runtime.sendMessage({ "storeStr": value, "storeVar": varName });
};
// © Ming-Hung Hsu, SideeX Team
/* KAT-BEGIN
Selenium.prototype.doStoreText = function(locator, varName) {
    ...
    chrome.runtime.sendMessage({ "storeStr": text, "storeVar": varName });
};
KAT-END */
// © Ming-Hung Hsu, SideeX Team
/* KAT-BEGIN
...
Selenium.prototype.doStoreValue = function(locator, varName) {
    ...
    chrome.runtime.sendMessage({ "storeStr": this.getValue(locator), "storeVar": varName });
};
KAT-END */
// © Ming-Hung Hsu, SideeX Team
Selenium.prototype.doEcho = function(value) {
    chrome.runtime.sendMessage({ "echoStr": value });
};
// © Ming-Hung Hsu, SideeX Team
Selenium.prototype.doStoreEval = function(value, varName) {
    chrome.runtime.sendMessage({ "storeStr": this.getEval(value), "storeVar": varName });
};
/* KAT-BEGIN
Selenium.prototype.doStoreAttribute = function(locator, varName) {    
    chrome.runtime.sendMessage({ "storeStr": this.getAttribute(locator), "storeVar": varName });
}
KAT-END */
