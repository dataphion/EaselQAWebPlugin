...
import {objectExtend,classCreate,fnBind,SeleniumError} from "./utils"

export var CommandHandlerFactory = classCreate();
    ...
    _registerStoreCommandForAccessor: function(baseName, accessBlock, requiresTarget) {
        ...
        if (requiresTarget) {
            action = function(target, varName) {
                ...
                chrome.runtime.sendMessage({ "storeStr": storedVars[varName], "storeVar": varName });
            };
        } else {
